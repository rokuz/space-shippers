...
#else
        private bool showAndroidUtils = false;// EditorUserBuildSettings.activeBuildTarget == BuildTarget.Android;
#endif
#if UNITY_IOS && !UNITY_EDITOR
        private bool showIOSSettings = EditorUserBuildSettings.activeBuildTarget.ToString() == "iOS";
#else
        private bool showIOSSettings = false;//EditorUserBuildSettings.activeBuildTarget.ToString() == "iOS";
#endif
